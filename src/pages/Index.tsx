...
import { ShoppingCart, Plus, Minus, Coffee, Star, Clock, MapPin, Phone, Mail } from 'lucide-react';
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
      {/* Header */}
      <header className="bg-gradient-to-r from-amber-800 via-orange-700 to-red-700 text-white shadow-2xl">
      ...
      {/* Hero Section */}
      <section className="relative py-20 px-4 text-center bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 text-white">
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <input
              ...
              className="flex-1 px-4 py-3 border-2 border-amber-200 rounded-full focus:border-amber-500 focus:outline-none transition-colors"
            />
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto">
          <h3 className="text-3xl font-bold text-center mb-12 text-amber-800">Our Menu</h3>
            ...
            {filteredItems.map(item => (
              <div key={item.id} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="relative">
                  ...
                  />
                  <div className="absolute top-4 right-4 bg-white bg-opacity-90 px-2 py-1 rounded-full text-sm font-bold text-amber-800">
                ...
                <div className="p-6">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-amber-600 to-orange-600 text-white py-3 rounded-full font-bold hover:from-amber-700 hover:to-orange-700 transition-all duration-300 transform hover:scale-105 active:scale-95"
                  >
                    Add to Cart
                  </button>
                </div>
            ...
            <div className="p-6">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 border rounded-lg focus:border-amber-500 focus:outline-none"
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 border rounded-lg focus:border-amber-500 focus:outline-none">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-amber-800 via-orange-700 to-red-700 text-white py-12">
